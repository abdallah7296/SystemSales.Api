...
namespace SystemSales.infrastructure.Migrations
{
    ...
    [Migration("20240727125236_supplierss")]
    partial class supplierss
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SystemSales.Data.Entities.Suppliers", b =>
                {
                    b.Property<string>("Suppliers_Code")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("Suppliers_Code");

                    b.ToTable("suppliers2");
                });

            modelBuilder.Entity("SystemSales.Data.Entities.SuppliersTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("Suplier_Invoice_Type")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<double?>("voucherCredit")
                        .HasColumnType("float");

                    b.Property<double?>("voucherDebit")
                        .HasColumnType("float");

                    b.HasKey("Id");

                    b.HasIndex("supplier_Code");

                    b.ToTable("suppliersTransactions");
                });
            ...
            modelBuilder.Entity("SystemSales.Data.Entities.SuppliersTransaction", b =>
                {
                    b.HasOne("SystemSales.Data.Entities.Suppliers", "Suppliers")
                        .WithMany("Transaction")
                        .HasForeignKey("supplier_Code")
